...
Ноутбук правится напрямую: пояснительные ячейки ведутся вручную.
[tools/build_notebook.py](tools/build_notebook.py) сохранён как история первоначальной
сборки и существующий файл не перезаписывает.
